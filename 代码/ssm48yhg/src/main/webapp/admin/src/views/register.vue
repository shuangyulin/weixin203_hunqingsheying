  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='cehuashi'" class="input-group">
			   <div class="label">策划账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.cehuazhanghao" class="input" type="text" placeholder="策划账号">
			   </div>
			 </div> -->
			<el-form-item label="策划账号" class="input" v-if="tableName=='cehuashi'">
			  <el-input v-model="ruleForm.cehuazhanghao" autocomplete="off" placeholder="策划账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='cehuashi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='cehuashi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='cehuashi'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='cehuashi'" class="input-group">
			   <div class="label">策划姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.cehuaxingming" class="input" type="text" placeholder="策划姓名">
			   </div>
			 </div> -->
			<el-form-item label="策划姓名" class="input" v-if="tableName=='cehuashi'">
			  <el-input v-model="ruleForm.cehuaxingming" autocomplete="off" placeholder="策划姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='cehuashi'" class="input-group">
			   <div class="label">邮箱</div>
			   <div class="input-container">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='cehuashi'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='cehuashi'" class="input-group">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='cehuashi'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `cehuashi` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
